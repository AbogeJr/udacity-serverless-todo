...
export async function getTodos(userId: string): Promise<TodoItem[]> {
  logger.info(
    `---------- Retrieve all todos for user with ID: ${userId} ----------`,
    { userId }
  )
...
export async function createTodo(
  ...
  logger.info(
    `---------- Create todo with ID: ${todoId} for user with ID: ${userId} ----------`,
    { userId, todoId, todoItem: newItem }
  )
...
export async function updateTodo(
  ...
  logger.info(
    `---------- Update todo with ID: ${todoId} for user with ID: ${userId} ----------`,
    { userId, todoId, todoUpdate: updateTodoRequest }
  )
...
export async function deleteTodo(userId: string, todoId: string) {
  logger.info(
    `---------- Delete todo with ID: ${todoId} for user with ID: ${userId} ----------`,
    { userId, todoId }
  )
...
export async function updateImageUrl(todoId: string, imageId: string) {
  logger.info(
    `---------- Generate attachment URL for attachment with ID: ${imageId} ----------`
  )
...
export async function generateUploadUrl(attachmentId: string): Promise<string> {
  logger.info(
    `---------- Generate upload URL for attachment with ID: ${attachmentId} ----------`
  )
